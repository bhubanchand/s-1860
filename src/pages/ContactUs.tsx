      ...
      <div className="pt-32 pb-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-muted-foreground max-w-2xl mx-auto mb-16">
            Have a question, feedback, or business inquiry? We'd love to hear from you. Fill out the form below or use one of our contact methods.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-secondary rounded-lg p-8 animate-fade-up delay-200">
                <h2 className="text-2xl font-bold mb-6">Follow Us</h2>
                <div className="flex space-x-4">
                  <a href="#" className="p-3 bg-muted rounded-full hover:bg-blog-green transition-colors">
